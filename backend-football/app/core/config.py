...
class Settings(BaseSettings):
    ...
    ai_system_prompt: str = (
        ...
        "Сделай из новости короткий пост или факт для Telegram-канала на русском языке. "
        ...
        "Длина зависит от материала: если новости хватает одного факта, пиши очень коротко; "
        "если без контекста или цитаты смысл теряется, можно дать 2-4 предложения. "
